/*
https://www.hackerrank.com/challenges/java-regex/copy-from/11979658
...
assign it to the pattern such that it can be used to validate an IP address. Use the following definition of an 
IP address:
